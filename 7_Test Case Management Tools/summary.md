...
1. Login
2. Add Project
![Add Project](./screenshots/01 add project.png)
...
5. Add Milestone
    ...
    ![Add Milestonre](./screenshots/02 add milestone.png)
6. Add Test Run
    ...
    ![Add Test Run](./screenshots/03 add test run.png)
7. Add Test Plan
    ...
    ![Add Test Plan](./screenshots/04 add test plan.png)
    ![Test Plan Overview](./screenshots/05 Test Plan Overview.png)
8. Add Test Case
    ...
    ![Add Test Case](./screenshots/06 add test case.png)
    ![Test Case Overview](./screenshots/07 Test Case Overview.png)
9. Add Result after testing
    ![Add Result](./screenshots/08 add result.png)    